<script>
  ...
  import {repos, currentRepos} from "../stores/store"
  let reposToShow = $currentRepos || $repos.filter((repo, index) => index < 3);
...
{#if !isDeleted}
    ...
    {#if isEditMode}
            <div class="projects__edit">
                <div><img src="/edit.svg" alt="icon"></div>
